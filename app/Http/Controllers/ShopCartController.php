...
public static function countshopcart()
{
    ...
    public function index()
    {
        ...
        return view('home.user.shopcart', ['data'=> $data]);
    }
    ...
    {
        return view('home.user.order', ['total' => $request->input('total')]);
    }
    ...
    public function storeorder(Request $request)
    {
        ...
        if ($cardcheck == "True") {
            ...
            return redirect()->route('shopcart.ordercomplete')->with('success', 'Order placed successfully.');
        } else {
            return redirect()->route('shopcart.ordercomplete')->with('error', 'Payment failed. Please try again.');
        }
    }
