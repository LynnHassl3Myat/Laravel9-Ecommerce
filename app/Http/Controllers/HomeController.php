...
class HomeController extends Controller
{
    ...
    public function storecomment(Request $request)
    {
        ...
        $data->ip = request()->ip();
        $data->save();
        return redirect()->route('product', ['id' => $request->input('product_id')])->with('success', 'Your review has been sent successfully!');
    ...
    public function categoryproducts($id)
    {
        ...
        return view('home.product', ['data' => $products, 'category' => $category]);
    }
